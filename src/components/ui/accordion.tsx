...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex p-4">
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="px-4 data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden text-sm"
      {...props}
    >
